...
export default function Footer() {
  return (
    <footer className="border-t bg-white/70 dark:bg-zinc-950/60 backdrop-blur py-10">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-5">
        ...
        <div className="flex items-center gap-5">
          <span className="text-muted-foreground text-sm">Built with 
            <Link
          ...
          <span className="flex gap-2">
            ...
            <Link href="https://github.com/" target="_blank" aria-label="GitHub" className="hover:text-black dark:hover:text-white transition-colors">
              <svg fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5">
